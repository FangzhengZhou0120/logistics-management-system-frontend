...
export const OrderManagement = () => {
    ...
    const onFinish = (values: any) => {
        ...
        values.clientId = Number(values.clientId ? values.clientId : user?.clientId)
        values.clientName = clientMap.current.get(values.clientId ? values.clientId.toString() : user?.clientId.toString())
